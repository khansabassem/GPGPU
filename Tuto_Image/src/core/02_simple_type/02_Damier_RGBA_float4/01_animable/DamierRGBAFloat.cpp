...
DamierRGBAFloat::DamierRGBAFloat(uint w , uint h , float dt , uint n , const DomaineMath& domaineMath) :
	Animable_I<float4>(w, h, "Damier_OMP_rgba_float4", domaineMath),//
 ...
 */
void DamierRGBAFloat::processForAutoOMP(float4* tabPixels , uint w , uint h , const DomaineMath& domaineMath)
    {
 ...
 */
void DamierRGBAFloat::processEntrelacementOMP(float4* tabPixels , uint w , uint h , const DomaineMath& domaineMath)
    {
    DamierRGBAFloatMath damierMath(n); // ici pour preparer cuda
