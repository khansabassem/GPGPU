...
class DamierHSBAFloat: public Animable_I<float4>
	 ...
	 */
	virtual void processEntrelacementOMP(float4* tabPixels , uint w , uint h , const DomaineMath& domaineMath);

	/**
	 * Call periodicly by the api
	 */
	virtual void processForAutoOMP(float4* tabPixels , uint w , uint h , const DomaineMath& domaineMath);
